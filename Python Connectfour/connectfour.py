...
winner.  No user interface is included; this is
...
# These constants specify the size of the game board
...
# Simple invalid move and game over exceptions
...
def drop_piece(game_state: ConnectFourGameState, column_number: int) -> ConnectFourGameState:
    ...
    that results when the current player drops a piece
...
def pop_piece(game_state: ConnectFourGameState, column_number: int) -> ConnectFourGameState:
    ...
    results when the current player pops a piece from the
